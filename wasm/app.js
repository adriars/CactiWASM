...
(function() {
 ...
 var loadPackage = function(metadata) {
  function runWithFS() {
   ...
   Module["FS_createPath"]("/", "tech_params", true, true);
   var start32 = Module["___emscripten_embedded_file_data"] >> 2;
   do {
    var name_addr = GROWABLE_HEAP_U32()[start32++];
    var len = GROWABLE_HEAP_U32()[start32++];
    var content = GROWABLE_HEAP_U32()[start32++];
    var name = UTF8ToString(name_addr);
    Module["FS_createDataFile"](name, null, GROWABLE_HEAP_I8().subarray(content, content + len), true, true, true);
   } while (GROWABLE_HEAP_U32()[start32]);
  }
  if (Module["calledRun"]) {
   runWithFS();
  } else {
...
var PThread = {
 ...
 allocateUnusedWorker: function() {
  var pthreadMainJs = locateFile("app.worker.js");
...
var ___emscripten_embedded_file_data = Module["___emscripten_embedded_file_data"] = 134692;

var __emscripten_allow_main_runtime_queued_calls = Module["__emscripten_allow_main_runtime_queued_calls"] = 161988;
